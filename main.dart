...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Phạm Duy Anh MSV : 1571020015'),
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String opp_1571020015 = ""; //mã sinh viên
  double soA = 0, soB = 0;
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Expanded(
              child: Container(
                color: Color.fromARGB(255, 21, 106, 75),
